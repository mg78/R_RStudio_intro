...
In the practical session we will focus on reading in some data, doing a bit of data manipulation, visualising data, complete some simple stats and use RMarkdown for writing up a report.
