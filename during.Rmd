...
If reading in the data from the wordbankr package directly isn't working, please download this csv-file and use that instea [wordbank_voc.csv](files/wordbank_voc.csv)
